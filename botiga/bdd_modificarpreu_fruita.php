...
<body>
    ...
    <div class="container" style="margin-top:30px">  
        <div class="row">
            <div class="col-2"> </div>
            <div class="col-8">
                <form action='bdd_fruita_modificapreu.php' method='GET'>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" step="any" name="preu" class="form-control" id="inputpreu">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputpreudte">Preu Dte</label>
                            <input type="number" step="any" name="preudte" class="form-control" id="inputpreudte">
                        </div>
                    </div>
